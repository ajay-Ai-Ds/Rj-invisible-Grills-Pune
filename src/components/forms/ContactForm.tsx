...
const contactFormSchema = z.object({
  ...
  area: z.string().min(2, { message: "Please specify your Pune neighborhood." }),
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Fill out the form to schedule a site measurement visit. Our technician will visit your location in Pune with material catalogs and share an accurate quotation.
              </p>
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="area" className="text-xs font-bold text-slate-700 tracking-wide">
                      Your Area/Neighborhood in Pune *
                    </label>
                    <input
                      type="text"
                      id="area"
