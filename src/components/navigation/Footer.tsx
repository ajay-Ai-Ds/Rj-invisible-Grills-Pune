    ...
    <footer className="bg-primary-800 text-slate-300 pt-16 pb-8 border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mt-2">
              RJ Invisible Grills is a premium provider of high-grade invisible grills and sports netting solutions in Pune, Maharashtra. Committed to absolute safety, premium durability, and aesthetic design.
            </p>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              ...
              <li className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+918019113644" className="hover:text-white transition-colors">
                    +91 80191 13644
                  </a>
                </div>
              </li>
              <li className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info.rjinvisiblegrills@gmail.com" className="hover:text-white transition-colors">
        ...
        <div className="pt-8 mt-8 border-t border-slate-800 text-center md:flex md:justify-between md:items-center text-xs text-slate-400">
          <p>© {currentYear} RJ Invisible Grills. All Rights Reserved. Built with absolute premium safety standards.</p>
