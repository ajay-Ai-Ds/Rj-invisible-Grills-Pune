...
export function ServiceWhyChoose() {
  ...
  return (
    <section className="bg-slate-50 py-20 scroll-mt-12" id="why-choose-rj">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16 flex flex-col gap-3">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-800">
            Why Choose RJ Invisible Grills
          </h2>
        </div>
...
// Related Services, Pune Areas, Blogs
...
export function ServiceRelated({ related, categoryName }: RelatedProps) {
  const areas = ["Kothrud", "Baner", "Hinjewadi", "Viman Nagar", "Wakad"];

  const blogs = [
    { title: "Essential Balcony Safety Tips for Families living in High-Rise Apartments" },
    { title: "Why SS316 Marine Grade Invisible Grills are Best for Pune Homes" },
                ...
                >
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-[10px] text-slate-500 font-medium">
                      Professional Installation Pune
                    </span>
                  </div>
