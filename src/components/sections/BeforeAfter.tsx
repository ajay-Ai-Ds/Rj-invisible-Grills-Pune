      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm leading-relaxed">
            See how our installations safeguard your family and pets while keeping your views clean and modern in Pune.
          </p>
        </div>
          ...
          >
            <div className="relative h-72 sm:h-96 w-full">
              ...
              <div className="absolute top-4 left-4 bg-success-green text-white text-xs font-bold uppercase px-3 py-1.5 rounded-md shadow-md flex items-center gap-1.5">
                ...
                <span>RJ INVISIBLE GRILLS PROTECTED</span>
              </div>
            </div>
            <div className="p-6">
              <h3 className="text-base font-bold text-slate-800 mb-2">After RJ Professional Setup</h3>
              <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
