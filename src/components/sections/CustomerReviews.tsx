      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm leading-relaxed">
            Verified feedback from homeowners and commercial property managers across Pune.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xs text-slate-500 leading-relaxed max-w-md">
            This section is reserved for real reviews from RJ Invisible Grills customer database. Ratings and testimonials will be populated as soon as verified client logs are shared.
          </p>
        </motion.div>
      </div>
    </section>
