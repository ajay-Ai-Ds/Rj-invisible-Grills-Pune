...
const benefits: Benefit[] = [
  ...
  },
  {
    ...
    description: "We offer quick inspections and free site measurements across Pune within 24 hours of booking.",
  },
  {
    id: 5,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute top-8 right-4 bg-primary-700 text-white p-6 rounded-2xl shadow-lg max-w-[180px] text-center">
              <span className="block text-2xl font-extrabold text-accent-orange mb-1">Pune</span>
