  ...
  const statItems = [
    {
      ...
      description: "Residential & commercial invisible grill and sports netting installations across Pune",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      value: "Content Required From Client",
      description: "Providing trusted protective netting services in Maharashtra",
    },
    {
      id: 4,
