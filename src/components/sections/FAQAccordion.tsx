...
const faqs: FAQItem[] = [
  {
    ...
    answer: "We specialize in premium SS316 marine-grade invisible wire grills (for balcony, window, and staircase safety) and high-tensile sports netting systems (Sports Nets and Cricket Practice Nets) customized to Pune residences and turfs.",
  },
  {
    id: 2,
    question: "Are your site inspection and measurements free of charge in Pune?",
    answer: "Yes, our technician site inspections, measurements, and catalog presentations are 100% free of charge across Pune and Pimpri-Chinchwad. There are no hidden costs or booking commitments.",
  },
  {
    id: 3,
  ...
  {
    id: 4,
    question: "Can your installations withstand Pune's summer heat and monsoons?",
