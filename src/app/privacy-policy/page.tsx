...
export const metadata: Metadata = {
  title: "Privacy Policy | RJ Invisible Grills Pune",
  description:
    "Review the privacy policy for RJ Invisible Grills, outlining our data handling practices, security protocols, and cookies policy for site inquiries.",
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-xs flex flex-col gap-6">
          ...
          <div className="space-y-6 text-xs sm:text-sm text-slate-500 leading-relaxed">
            <p>
              Last Updated: July 10, 2026. RJ Invisible Grills (&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) operates the website https://www.rjinvisiblegrills.com. We respect your privacy and are committed to protecting any personal identifiable information you share with us.
            </p>
            ...
            <p>
              When you submit a quote request or contact form on our website, we collect your Name, Phone Number, Pune neighborhood/area, and details of the requested sports nets or invisible grill service. This information is required to coordinate free site visits and provide custom quotations.
            </p>
            ...
            <p>
              Your contact requests are stored securely on our email and analytics databases. However, specific details regarding RJ&apos;s data purging timelines and compliance certificates are marked as:
            </p>
            <div className="pt-1">
