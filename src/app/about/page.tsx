...
export const metadata: Metadata = {
  title: "About Us | Invisible Grills & Sports Nets Specialists Pune | RJ",
  description:
    "Learn about RJ Invisible Grills, Pune's trusted provider of high-tension balcony invisible grills, staircase grills, window grills, and sports netting systems. Custom installations.",
  alternates: {
    canonical: "/about",
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-16 flex flex-col gap-3">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-800 tracking-tight leading-tight">
            About RJ Invisible Grills
          </h1>
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            We are Pune&apos;s leading safety invisible steel wire grill and sports netting specialists, securing residential balconies, open window frames, and commercial play courts.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16 items-start">
          ...
          <div className="lg:col-span-8 flex flex-col gap-8 text-left">
            <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-xs flex flex-col gap-5">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                RJ Invisible Grills was established in Pune to address critical safety gaps in high-rise living. With the rapid development of residential townships along Hinjewadi, Baner, and Wakad, open balconies and low railings have become active hazards for children and household pets.
              </p>
              <p className="text-slate-500 text-sm leading-relaxed">
          ...
          <div className="lg:col-span-4 bg-slate-900 text-white rounded-3xl p-6 sm:p-8 border border-slate-800 flex flex-col gap-6">
            ...
            <p className="text-slate-500 text-[10px] leading-relaxed pt-2 border-t border-white/10">
              RJ Invisible Grills maintains strict compliance standards. All ratings, years of operation, and structural safety certs will be published once the client submits certified copies.
            </p>
          </div>
        </div>
