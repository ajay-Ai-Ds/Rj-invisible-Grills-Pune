...
export const metadata: Metadata = {
  title: "Balcony Safety & Home Childproofing Blog | RJ Invisible Grills",
  description:
    "Expert tips on child safety, bird netting, and invisible grill installations from RJ Invisible Grills in Pune.",
  alternates: {
    canonical: "/blog",
  },
};
...
export default async function BlogPage() {
  ...
  const collectionSchema = {
    ...
    "@type": "CollectionPage",
    "name": "Safety and Home Childproofing Blog | RJ",
    "url": "https://www.rjinvisiblegrills.com/blog",
