...
export const metadata: Metadata = {
  title: "Contact Us | Free Site Measurement & Quote Pune | RJ",
  description:
    "Get in touch with RJ Invisible Grills for professional sports nets and invisible grill setup. Call +91 80191 13644 or request a free quote online.",
  alternates: {
    canonical: "/contact",
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16 items-start">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <a href="tel:+918019113644" className="text-sm font-bold text-slate-700 hover:text-accent-orange transition-colors">
                    +91 80191 13644
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <a href="mailto:info.rjinvisiblegrills@gmail.com" className="text-sm font-bold text-slate-700 hover:text-accent-orange transition-colors">
          ...
          <div className="lg:col-span-7 flex flex-col gap-3">
            ...
            <MapFrame areaName="Pune" className="h-[360px]" />
          </div>
        </div>
