...
export async function generateMetadata({ params }: PageProps) {
  ...
  if (!serviceDetail) {
    return {
      title: "Service Not Found | RJ Invisible Grills",
    };
  }
  ...
  return {
    ...
    openGraph: {
      title: `${serviceDetail.title}`,
      description: serviceDetail.description,
      url: `https://www.rjinvisiblegrills.com/services/${resolvedParams.service}`,
      images: [
        {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16 flex flex-col gap-3">
            ...
            <p className="text-slate-500 text-xs sm:text-sm">
              Drag the central divider bar to see the direct aesthetic difference between unprotected spaces and a secure RJ setup.
            </p>
          </div>
          <BeforeAfterSlider
