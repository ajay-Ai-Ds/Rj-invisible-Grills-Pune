...
export const metadata = {
  title: "Professional Invisible Grill & Sports Netting Services in Pune | RJ Invisible Grills",
  description:
    "Explore our 5 premium installation services in Pune: balcony, window, and staircase invisible grills, sports nets, and cricket practice nets.",
  alternates: {
    canonical: "/services",
  },
};
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "Home",
        "item": "https://www.rjinvisiblegrills.com",
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": "Services",
        "item": "https://www.rjinvisiblegrills.com/services",
      },
    ],
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-16 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            Choose from our 5 certified invisible steel wire grills and sports netting services in Pune. Handcrafted to protect your space cleanly.
          </p>
        </div>
