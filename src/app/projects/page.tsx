...
export const metadata: Metadata = {
  title: "Completed Invisible Grills & Sports Nets Projects Pune | RJ",
  description:
    "Explore RJ Invisible Grills portfolio of professional sports nets and invisible grills across Pune housing complexes.",
  alternates: {
    canonical: "/projects",
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-12 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            Review case profiles of completed sports nets and invisible grills installed by RJ Invisible Grills in residential complexes and sports turfs across Pune.
          </p>
        </div>
