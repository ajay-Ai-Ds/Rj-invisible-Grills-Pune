...
export const metadata: Metadata = {
  title: "Terms & Conditions | Service & Installation Agreements | RJ",
  description:
    "Review RJ Invisible Grills terms and conditions for sports nets and invisible grill installations, service warranties, and payment policies in Pune.",
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-xs flex flex-col gap-6">
          ...
          <div className="space-y-6 text-xs sm:text-sm text-slate-500 leading-relaxed">
            <p>
              Welcome to the RJ Invisible Grills website (https://www.rjinvisiblegrills.com). By accessing our site and booking our safety installations, you agree to comply with and be bound by the following terms of service.
            </p>
            ...
            <p>
              We provide free measurement visits across listed Pune areas. Our technician will share structural catalog samples. Inquiries submitted do not constitute a binding installation contract until a detailed estimate is accepted by the client.
            </p>
            ...
            <p>
              RJ Invisible Grills installs high-quality monofilament sports netting and invisible grills. Warranty terms vary by material mesh thickness and UV-stability ratings. Standard warranty duration agreements are strictly subject to client confirmation and are marked as:
            </p>
            <div className="pt-1">
              <span className="text-xs font-bold text-orange-800 bg-orange-100 border border-orange-200 px-3 py-1.5 rounded-md inline-block">
                Content Required From Client
            ...
            <p>
              Any disputes or legal inquiries relating to installations, material sales, or contracts executed by RJ Invisible Grills are governed under the exclusive jurisdiction of the courts of Pune, Maharashtra, India.
            </p>
          </div>
        </div>
      </div>
