...
export const metadata: Metadata = {
  title: "Search Services, Areas & Blogs | RJ Invisible Grills",
  description:
    "Search across RJ Invisible Grills balcony invisible steel wire grills, sports nets, case study projects, and coverage areas in Pune.",
  alternates: {
    canonical: "/search",
  },
};
