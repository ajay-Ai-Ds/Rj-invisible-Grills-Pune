...
export async function generateMetadata({ params }: PageProps) {
  ...
  if (!areaDetail) {
    return {
      title: "Area Not Found | RJ Invisible Grills",
    };
  }

  return {
    title: `Invisible Grills & Sports Nets in ${areaDetail.name}, Pune | RJ`,
    description: `RJ Invisible Grills offers professional balcony, window, and staircase invisible grills, sports nets, and cricket practice nets in ${areaDetail.name}, Pune. Free measurements.`,
    alternates: {
    ...
    openGraph: {
      title: `Invisible Grills & Sports Nets in ${areaDetail.name}, Pune | RJ`,
      description: `RJ Invisible Grills offers professional balcony, window, and staircase invisible grills, sports nets, and cricket practice nets in ${areaDetail.name}, Pune. Free measurements.`,
      url: `https://www.rjinvisiblegrills.com/areas/${resolvedParams.area}`,
      images: [
        {
  ...
  const localFAQs = [
    {
      ...
      answer: `No. RJ Invisible Grills offers 100% free site visits, catalog displays, and measurements in ${areaDetail.name} and surrounding Pune locations without any payment commitments.`,
    },
    {
    ...
    {
      question: `Can RJ invisible grills handle the weather in ${areaDetail.name}?`,
      answer: `Yes. Our invisible grills utilize marine-grade SS316 stainless steel wires wrapped in a clear nylon protective casing. They are highly rustproof and resist Pune's extreme summer heat and seasonal monsoon weather.`,
    },
  ];
        ...
        <div className="bg-slate-900 rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden mb-16 shadow-md">
          ...
          <div className="relative z-10 max-w-2xl flex flex-col gap-5 items-start">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              Premium invisible steel wire grills, balcony safety barriers, and custom sports netting installed by certified professionals in {areaDetail.name}, Pune.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20 max-w-xl flex flex-col gap-2">
              ...
              <p className="text-xs text-slate-200 leading-relaxed font-semibold">
                RJ Invisible Grills is the leading installer in {areaDetail.name}, Pune. We provide balcony, window, and staircase invisible grills, sports nets, and cricket practice nets custom anchored with free measurements.
              </p>
            </div>
