...
export const projectsData: Record<string, ProjectDetail> = {
  "invisible-grills-hinjewadi": {
    slug: "invisible-grills-hinjewadi",
    name: "Window and Balcony Invisible Grills in Hinjewadi High-Rise Apartment",
    ...
    description: "Elegant invisible steel wire grill installation along balcony railings of a high-rise IT corridor apartment in Hinjewadi.",
    problem: "The resident of a 14th-floor Hinjewadi apartment wanted to secure their balcony for pet and child safety. Traditional heavy iron grills blocked the view and clashed with the modern glass facade of the building.",
    solution: "RJ Invisible Grills installed SS316 marine-grade invisible steel wire grills spaced 3 inches apart. The wires are wrapped in a clear nylon sleeve to prevent scratches, clamped firmly in heavy aluminium base tracking.",
    materialsUsed: [
    ...
    image: imageAssets.projectHinjewadi.url,
    gallery: [
      imageAssets.projectHinjewadi.url,
  ...
  "sports-nets-kothrud": {
    slug: "sports-nets-kothrud",
    name: "Sports Netting Installation at Kothrud Sports Club",
    category: "sports-nets",
    service: "sports-nets",
    serviceName: "Sports Nets",
    location: "Kothrud",
    locationSlug: "kothrud",
    date: "Content Required From Client",
    description: "Installation of heavy-duty sports boundary netting for a football and multi-sport play court in Kothrud, Pune.",
    problem: "A sports club in Kothrud faced issues with balls repeatedly flying out of the playground, risking damage to neighboring residential windows and vehicles.",
    solution: "RJ Invisible Grills installed a 20-foot-high, impact-absorbing sports boundary net utilizing UV-stabilized braided nylon mesh, secured with steel frame wires and anchored structural poles.",
    materialsUsed: [
    ...
    image: imageAssets.projectKothrud.url,
    gallery: [
      imageAssets.projectKothrud.url,
  ...
  "cricket-nets-baner": {
    slug: "cricket-nets-baner",
    name: "Terrace Cricket Practice Net Installation in Baner",
    category: "sports-nets",
    ...
    locationSlug: "baner",
    date: "Content Required From Client",
    description: "Installation of professional-grade cricket practice netting on the terrace of a sports academy in Baner, Pune.",
    ...
    solution: "RJ Invisible Grills designed and installed a complete 3D box cricket net enclosure using thick UV-treated nylon twine and SS anchoring eyelets.",
    materialsUsed: [
    ...
    image: imageAssets.projectBaner.url,
    gallery: [
      imageAssets.projectBaner.url,
