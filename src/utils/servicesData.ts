...
function generateFAQsForService(serviceName: string, category: string): FAQItem[] {
  return [
    {
      question: `What is the cost of ${serviceName} installation in Pune?`,
    ...
    },
    {
      ...
      answer: "Yes, RJ Invisible Grills offers warranties on premium stainless steel wire cables and heavy-duty netting. Exact warranty terms, duration, and certificates will be shared during site inspection.",
    },
    {
    ...
    },
    {
      ...
      answer: `Yes, we use copolymer nylon or UV-treated HDPE for sports nets, and SS316 marine-grade steel cables for grills. These materials are engineered to survive Pune's high summer heat, direct sunlight, and monsoon rains.`,
    },
    {
      question: `Do you charge for site inspection visits and measurements in Pune?`,
      answer: `No, our site inspection, measurements, and material sample showcases are 100% free of charge across Pune and Pimpri-Chinchwad. There is no obligation to book after the quotation is shared.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Yes, all RJ Invisible Grills field technicians are trained in safety harness usage and high-rise installation guidelines. They are fully insured and handle high-floor setups professionally.`,
    },
    {
    ...
    {
      question: `How do we contact RJ Invisible Grills for booking?`,
      answer: "You can book a free measurement session by calling us directly at 8019113644, sending a message on WhatsApp, or submitting our contact request form.",
    },
  ];
}
...
export const servicesData: Record<string, ServiceDetail> = {
  "balcony-invisible-grills": {
    ...
    title: "Balcony Invisible Grills Installation Pune | RJ Invisible Grills",
    description: "Rustproof marine-grade SS316 cable grills for balcony security. Enjoy unobstructed panoramic views in Pune.",
    longDescription: "Elevate your high-rise balcony security in Pune. Our invisible grills utilize pre-tensioned, marine-grade SS316 stainless steel wires wrapped in a clear nylon protective casing. They offer absolute security for children and pets without spoiling the scenic view of your balcony. They represent a highly durable, aesthetic replacement for old-fashioned heavy iron grids.",
    aiOverview: "RJ Balcony Invisible Grills feature high-strength SS316 steel wires wrapped in protective nylon coatings. They replace heavy iron grids to secure balconies for children and pets while preserving unobstructed view layouts.",
  ...
  "window-invisible-grills": {
    ...
    category: "invisible-grills",
    categoryName: "Invisible Grills",
    title: "Aesthetic Window Invisible Grills Pune | RJ Invisible Grills",
    description: "Replace dark iron bars with modern window invisible steel grills. Admire unobstructed breezes and light in Pune.",
    longDescription: "An elegant alternative to traditional iron safety bars for Pune apartments. Window invisible grills use vertical or horizontal SS316 steel wires. They offer security from falls and intruders without looking bulky or obstructing ventilation, making rooms brighter and safer.",
    aiOverview: "RJ Window Invisible Grills offer safety without dark prison-like bars. Utilizing thin-profile SS316 wires clamped in aluminum anchor tracks, they optimize lighting and air circulation.",
  ...
  "staircase-invisible-grills": {
    ...
    category: "invisible-grills",
    categoryName: "Invisible Grills",
    title: "Interior Staircase Handrail Invisible Grills Pune | RJ Invisible Grills",
    description: "Secure open banisters and stair handrails with vertical safety steel cables. Sleek indoor security in Pune.",
    longDescription: "Stairwells in open-concept duplex villas, malls, and educational institutions in Pune present significant height fall hazards. Our vertical invisible grills close up these open spaces cleanly without compromising modern interior designs, ensuring child and pet safety.",
    aiOverview: "RJ Staircase Invisible Grills secure stair railings using sleek vertical SS316 wires. Providing high tension safety for children, they blend seamlessly into premium modern architectural interiors.",
  ...
  "sports-nets": {
    ...
    title: "Sports Ground & Boundary Nets Pune | RJ Invisible Grills",
    description: "Heavy impact-resistant sports boundary netting for cricket turf, football pitches, and open grounds in Pune.",
    longDescription: "High-grade cricket, football, and multi-sport safety boundary nets for sports complexes, schools, and residential terraces in Pune. Woven with premium high-density nylon cord, these nets are designed to withstand constant ball impacts and protect nearby properties and spectators.",
    aiOverview: "RJ Sports Nets provide impact-resistant enclosing barriers for cricket pitches, terraced sports grounds, and school courts. Made of high-grade braided nylon, they absorb huge strike forces while surviving outdoor sun.",
  ...
  "cricket-practice-nets": {
    ...
    category: "sports-nets",
    categoryName: "Sports Nets",
    title: "Cricket Practice Nets Installation in Pune | RJ Invisible Grills",
    description: "Professional cricket practice nets for indoor & outdoor setups, academies, schools, and residences in Pune.",
    longDescription: "RJ Invisible Grills offers professional cricket practice netting solutions across Pune. We install durable, impact-absorbing nets for sports academies, educational clubs, corporate turfs, and residential terraces. Our cricket nets are made of high-quality UV-stabilized nylon ropes and braided twine that absorb strong ball strikes without tearing.",
    aiOverview: "RJ Cricket Practice Nets offer heavy-impact ball containment using UV-treated braided nylon mesh. Engineered for commercial sports turfs and home terraces, they provide durable practice zones in Pune.",
  ...
  "children-safety-invisible-grills": {
    ...
    category: "invisible-grills",
    categoryName: "Invisible Grills",
    title: "Children Safety Balcony Invisible Grills Pune | RJ",
    description: "Kid-friendly balcony invisible steel grills. High-tension wire setups protecting toddlers in Pune apartments.",
    ...
    aiOverview: "RJ Children Safety Invisible Grills utilize closely anchored SS316 tension wires to secure high balconies and open railings. Fully kid-safe, they replace bulky iron frames in Pune.",
  ...
  "pet-safety-invisible-grills": {
    ...
    category: "invisible-grills",
    categoryName: "Invisible Grills",
    title: "Pet Safety Balcony & Window Invisible Grills Pune | RJ",
    description: "Bite-proof and scratch-resistant invisible steel wire grills for cats and dogs in Pune.",
    longDescription: "Keep your feline and canine companions safe in high-rise Pune apartments. Our pet safety invisible grills feature tightly tensioned, ultra-durable steel cables spaced closely (usually 2 to 3 inches) to prevent cats or dogs from squeezing through or falling, while offering complete bite-proof safety.",
    aiOverview: "RJ Pet Safety Invisible Grills offer bite-proof SS316 cable arrays spaced tightly to secure active cats and dogs on balcony railings and open window ledges in Pune.",
  ...
  "pigeon-invisible-grills": {
    ...
    category: "invisible-grills",
    categoryName: "Invisible Grills",
    title: "Pigeon & Bird Exclusion Invisible Grills Pune | RJ",
    description: "Tightly spaced invisible steel grills to block pigeons and birds from entering balconies in Pune.",
    ...
    aiOverview: "RJ Pigeon Invisible Grills utilize ultra-thin, closely spaced SS316 cables to prevent bird nesting and droppings on Pune balconies. Rustproof and clean, they preserve panoramic views.",
